...
SET ANDROID_SDK_ROOT=C:\Users\gsalt\AppData\Local\Android\Sdk


SET PATH=%PATH%;C:\Program Files\Java\jdk1.8.0_311\bin;
SET PATH=%PATH%;C:\Users\gsalt\AppData\Local\Android\Sdk\tools;
SET PATH=%PATH%;C:\Users\gsalt\AppData\Local\Android\Sdk\platform-tools;
