...
//$(document).ready(async function(){
	...
	//Soluzione 2 
	await caricaGoogleMaps(); //Fa sembrare sincrona una procedura asincrona: blocca fino al then	
	documentReady();
}
function documentReady () {	
  //Essenziale nel caso di utilizzo dei sensori	
  document.addEventListener('deviceready', function() { //-> tramite questa riga, funziona solo su cellulare 
	//alert("start");
