...
$(document).ready(function() {
    ...
    /*Per il logout è inutile inviare una richiesta al server. E' sufficiente cancelare il cookie o il token dal pc client. Una richiesta al server semplificherebbe la cancellazione del cookie*/
